...
using Proxxi.Cli.Commands.Pack.Install;
using Proxxi.Cli.Commands.Pack.Remove;
...
app.Configure(config =>
{
    ...
    config.AddBranch("pack", packConfig =>
    {
        packConfig.SetDescription("Manage plugins packages.");

        packConfig.AddCommand<InstallCommand>("install")
            .WithDescription("Install a plugins with (.pxp) package.");

        packConfig.AddCommand<RemoveCommand>("remove")
